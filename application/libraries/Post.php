...
class Post extends BaseRow
{
	...
	{
		//простые поля  
		$rows=array('name'=>'text','img'=>'file_img','title'=>'text','description'=>'text','keywords'=>'text','url'=>'text','time'=>'date_time','text'=>'textarea');
		$placeholder=array('name'=>'Название','img'=>'Картинка','language'=>'Язык материала','title'=>'meta-Title','description'=>'meta-description','keywords'=>'meta-keywords','url'=>'Адрес страницы','time'=>'Время публикации','text'=>'Текст','is_category'=>'Является разделом','parent'=>'Родительская категория');
		$form=array();
		foreach ($rows as $k=>$v) {
